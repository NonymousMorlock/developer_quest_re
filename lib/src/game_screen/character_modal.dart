...
class CharacterModal extends StatelessWidget {
  ...
  CharacterModal({Key? key}) : super(key: key);
  @override
...
class CharacterImage extends StatelessWidget {
  const CharacterImage(this._controls, {super.key});
...
class CharacterStats extends StatelessWidget {
  const CharacterStats(this._controls, {super.key});
...
class UpgradeHireButton extends StatelessWidget {
  const UpgradeHireButton(this._controls, {super.key});
...
class SkillDisplay extends StatelessWidget {
  const SkillDisplay(this.skill, {super.key});
