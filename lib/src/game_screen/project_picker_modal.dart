...
import '../../../src/shared_state/game/task_pool.dart';
import '../../../src/shared_state/game/task_tree/task_tree.dart';
import '../../../src/shared_state/game/task_tree/tree_hierarchy.dart';
import '../../../src/style.dart';
import '../../../src/widgets/task_picker/task_picker_header.dart';
import '../../../src/widgets/task_picker/task_picker_item.dart';
...
class ProjectPickerModal extends StatelessWidget {
  const ProjectPickerModal({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var taskPool = Provider.of<TaskPool>(context);
    var tasks = taskPool.availableTasks.toList(growable: false)
    ...
    var alpha =
        _buildTaskPickerSlivers(taskPool.alpha.tasks, tasks, completed);
    var beta = _buildTaskPickerSlivers(taskPool.beta.tasks, tasks, completed);
    var v1 = _buildTaskPickerSlivers(taskPool.v1.tasks, tasks, completed);
