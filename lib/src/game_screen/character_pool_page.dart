import '../../../src/game_screen/character_modal.dart';
...
class CharacterPoolPage extends StatelessWidget {
  ...
  const CharacterPoolPage({this.numColumns = 2, super.key});
...
class CharacterListItem extends StatelessWidget {
  const CharacterListItem({Key? key}) : super(key: key);
...
class CharacterDisplay extends StatelessWidget {
  const CharacterDisplay({Key? key}) : super(key: key);
...
class HiringInformation extends StatelessWidget {
  const HiringInformation(this.bustState, {super.key});
