import '../../../src/game_screen/character_style.dart';
import '../../../src/shared_state/game/character.dart';
import '../../../src/shared_state/game/character_pool.dart';
import '../../../src/shared_state/game/work_item.dart';
import '../../../src/style.dart';
import '../../../src/widgets/buttons/wide_button.dart';
import '../../../src/widgets/flare/hiring_bust.dart';
import '../../../src/widgets/flare/skill_icon.dart';
import '../../../src/widgets/prowess_progress.dart';
import '../../../src/widgets/skill_badge.dart';
...
class TeamPickerModal extends StatefulWidget {
  ...
  const TeamPickerModal(this.workItem, {super.key});

  @override
  TeamPickerModalState createState() {
    return TeamPickerModalState();
  }
}

class TeamPickerModalState extends State<TeamPickerModal> {
  late Set<Character> _selected;
  Iterable<Character>? initialTeam;
  ...
  @override
  void initState() {
    initialTeam = widget.workItem.assignedTeam;
...
class TeamPickerItem extends StatelessWidget {
  ...
  const TeamPickerItem(this.character,
      {super.key, this.isSelected = false, required this.toggleSelection, required this.isDisabled});
