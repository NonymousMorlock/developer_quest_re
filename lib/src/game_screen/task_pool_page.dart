...
import '../../../src/widgets/work_items/bug_list_item.dart';
import '../../../src/widgets/work_items/task_list_item.dart';
import '../../../src/widgets/work_items/tasks_button_header.dart';
import '../../../src/widgets/work_items/tasks_section_header.dart';
...
class TaskPoolPage extends StatelessWidget {
  ...
  const TaskPoolPage({this.display = TaskPoolDisplay.all, super.key});
      ...
      slivers.add(SliverList(
        delegate: SliverChildBuilderDelegate((context, index) {
          ...
          return ChangeNotifierProvider<WorkItem>.value(
            value: item,
            key: ValueKey(item),
            child: item is Bug ? const BugListItem() : const TaskListItem(),
          );
