...
import '../../../src/widgets/flare/warmup_flare.dart';
import '../../../src/widgets/buttons/welcome_button.dart';
import '../../../src/widgets/flare/start_screen_hero.dart';
...
class _WelcomeScreenSlim extends StatelessWidget {
  ...
  const _WelcomeScreenSlim(this.hero, {required this.start, required this.about});
...
class _WelcomeScreenWide extends StatelessWidget {
  ...
  final VoidCallback about;
  final CharacterStyle hero;
  const _WelcomeScreenWide(this.hero, {required this.start, required this.about});
  @override
  Widget build(BuildContext context) {
