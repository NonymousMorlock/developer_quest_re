...
import '../../flare_flutter/base/math/aabb.dart';
import '../../flare_flutter/provider/asset_flare.dart';

import '../../../src/code_chomper/code_chomper.dart';
import '../../flare_flutter/flare_render_box.dart';
import '../../flare_flutter/flare.dart';
...
class CodeChomperScreen extends LeafRenderObjectWidget {
  ...
  const CodeChomperScreen(this.controller, {super.key});
...
class CodeChomperScreenRenderObject extends FlareRenderBox {
  ...
  late FlutterActorArtboard _chompy;
  late AssetBundle assetBundle;
  late ActorAnimation _chompyIdle;
  late ActorAnimation _chompyChomp;
  late ActorAnimation _chompyAppear;
  late FlutterActorArtboard _fui;
  late ActorAnimation _fuiTap;
  Offset? _fuiOffset;
  ...
  CodeChomperScreenRenderObject(AssetBundle bundle) {
    ...
    loadFlare(AssetFlare(name: 'assets/flare/Chomper.flr', bundle: assetBundle)).then((actor) {
    ...
    loadFlare(AssetFlare(bundle: assetBundle, name: 'assets/flare/Chomper FUI Type.flr')).then((actor) {
  ...
  @override
  AABB? get aabb => _fui.artboardAABB();
