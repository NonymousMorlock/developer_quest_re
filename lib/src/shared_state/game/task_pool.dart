...
import '../../../src/shared_state/game/src/aspect_container.dart';
import '../../../src/shared_state/game/src/child_aspect.dart';
...
class TaskPool extends AspectContainer with ChildAspect {
  ...
  // The tasks that are archived (user got their reward).
  ...
  /// them next.
  Iterable<TaskBlueprint> get availableTasks {
    return taskTree.where((blueprint) {
      return !tasks.any((item) => item.blueprint == blueprint) &&
