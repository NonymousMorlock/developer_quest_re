...
import '../skill.dart';
import 'tree_hierarchy.dart';

import '../task_blueprint.dart';
import '../task_prerequisite.dart';
...
class TaskNode implements TreeData {
  ...
  List<Prerequisite> get allPrerequisites => [blueprint, ...children.expand((child) => child.allPrerequisites).toList()];
}
