...
import '../../shared_state/game/character.dart';
import '../../shared_state/game/skill.dart';
import '../../shared_state/game/src/aspect.dart';
import '../../shared_state/game/src/child_aspect.dart';
...
abstract class WorkItem extends Aspect with ChildAspect {
  ...
  void assignTeam(List<Character> team) {
    if (_assignedTeam != null) {
      ...
      for (var character in _assignedTeam!) {
