...
import '../../shared_state/game/company.dart';
import '../../style.dart';
...
abstract class StatBadge<T extends num> extends StatefulWidget {
  ...
  const StatBadge(this.stat, this.statValue,
      {super.key, required this.flare, this.scale = 1, required this.isWide});
...
class _SlimStatData extends StatelessWidget {
  ...
  final double scale;
  final String stat;
  const _SlimStatData({required this.listenable, required this.scale, required this.stat});
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _WideStatData extends StatelessWidget {
  ...
  final double scale;
  final String stat;
  const _WideStatData({required this.listenable, required this.scale, required this.stat});
  @override
  Widget build(BuildContext context) {
    return Row(
