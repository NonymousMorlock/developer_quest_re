...
import '../../../src/widgets/flare/desaturated_actor.dart';
import '../../../src/widgets/flare/hiring_particles.dart';
...
class HiringBustRenderObject extends FlareRenderBox {
  ...
  String _filename = 'assets/flare/TheJack.flr';
  ...
  set assetBundle(AssetBundle assetBundle) {
    if (_assetBundle == assetBundle) {
      return;
    }
  ...
  Future<void> load() async {
    FlutterActor? actor = (await loadFlare(AssetFlare(bundle: _assetBundle!, name: _filename)));
    if (actor == null) {
      return;
    }
