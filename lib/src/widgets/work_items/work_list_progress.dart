...
class WorkListProgress extends StatefulWidget {
  ...
  const WorkListProgress({super.key, required this.workItem, required this.progressColor});

  @override
  State<WorkListProgress> createState() => _WorkListProgressState();
}
...
class TapButton extends StatefulWidget {
  ...
  const TapButton({super.key, required this.color, required this.isDisabled, this.onPressed});
